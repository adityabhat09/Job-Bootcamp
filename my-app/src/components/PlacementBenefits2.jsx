...
const PlacementBenefits2 = () => {
    const benefits = [
        ...
        {
            icon: <Edit3 className="w-6 h-6 text-orange-400" />,
            title: "Soft skills",
    ...
    return (
        <DottedBackground className=' bg-gray-900 text-white px-8 py-10 '>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {benefits.map((benefit, index) => (
                            <div
                                key={index}
                                className="bg-gray-800 rounded-2xl p-6 border border-gray-700 hover:border-[#C63687] transition-all duration-300 hover:transform hover:scale-105 justify-items-center"
                            >
                                <div className="mb-4 ">
                                    {benefit.icon}
                                </div>
